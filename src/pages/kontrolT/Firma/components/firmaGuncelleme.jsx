...
const FirmaGuncelle = () => {
  ...
  const {firma_adi,firma_adresi_1,firma_adresi_2,sehir_kodu,ulke_kodu} = firmaData;
    ...
    <div className="min-h-screen bg-gray-100 flex justify-center items-start pt-8">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-4xl">
        <h1 className="text-3xl font-bold text-gray-800 mb-6 text-center">
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-medium mb-2" htmlFor="firma_kodu">
              Firma Kodu
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-medium mb-2" htmlFor="firma_adi">
              Firma Adı
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-medium mb-2" htmlFor="firma_adresi_1">
              Adres 1
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-medium mb-2" htmlFor="firma_adresi_2">
              Adres 2
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-medium mb-2" htmlFor="sehir_kodu">
              Şehir Kodu
            </label>
            <input
              type="text"
          ...
          <div className="mb-4">
            <label className="block text-gray-700 font-medium mb-2" htmlFor="ulke_kodu">
              Ülke Kodu
            </label>
            <input
              type="text"
